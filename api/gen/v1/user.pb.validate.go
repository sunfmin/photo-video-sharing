...
func (m *PasswordResetRequest) _validateHostname(host string) error {
	s := strings.ToLower(strings.TrimSuffix(host, "."))
...
func (m *PasswordResetRequest) _validateEmail(addr string) error {
	a, err := mail.ParseAddress(addr)
	if err != nil {
		return err
	}
...
func (m *PasswordResetResponse) validate(all bool) error {
	...
	// no validation rules for EmailSent
